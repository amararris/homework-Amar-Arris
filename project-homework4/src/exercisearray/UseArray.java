...
public class UseArray {
    ...
    public static void main(String[] args) {
        ...
        union.addAll(set2); // union array1 and array2
        System.out.println("the union is " + union);

        Set<Integer> intersection = new HashSet<>(set1);
        intersection.retainAll(set2); //intersection array1 and array2
        System.out.println("the intersection is "+ intersection);

        Set<Integer> symmetricDifference = new HashSet <>(union);
        symmetricDifference.removeAll(intersection); // SymmetricDifference array1 and array2
